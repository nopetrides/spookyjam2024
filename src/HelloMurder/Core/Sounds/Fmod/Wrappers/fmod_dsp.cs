...
namespace FMOD
{
    ...
    */
    ...
    public struct DSP_PARAMETER_FFT
    {
        ...
        [MarshalAs(UnmanagedType.ByValArray,SizeConst=32)]
        private readonly IntPtr[] _spectrum_internal;
        ...
        public float[][] Spectrum
        {
            get
            {
                ...
                for (int i = 0; i < numchannels; ++i)
                {
                    ...
                    Marshal.Copy(_spectrum_internal[i], buffer[i], 0, length);
                }
        ...
        public void GetSpectrum(int channel, ref float[] buffer)
        {
            ...
            Marshal.Copy(_spectrum_internal[channel], buffer, 0, bufferLength);
        }
    }
