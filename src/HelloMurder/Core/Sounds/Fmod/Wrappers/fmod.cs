    ...
    */
    ...
    public struct CREATESOUNDEXINFO
    {
        ...
        public SOUND_PCMREAD_CALLBACK? Pcmreadcallback
        {
            ...
            get { return pcmreadcallback_internal == IntPtr.Zero ? null : (SOUND_PCMREAD_CALLBACK)Marshal.GetDelegateForFunctionPointer<SOUND_PCMREAD_CALLBACK>(pcmreadcallback_internal); }
        }
        public SOUND_PCMSETPOS_CALLBACK? Pcmsetposcallback
        {
            ...
            get { return pcmsetposcallback_internal == IntPtr.Zero ? null : (SOUND_PCMSETPOS_CALLBACK)Marshal.GetDelegateForFunctionPointer<SOUND_PCMSETPOS_CALLBACK>(pcmsetposcallback_internal); }
        }
        public SOUND_NONBLOCK_CALLBACK? Nonblockcallback
        {
            ...
            get { return nonblockcallback_internal == IntPtr.Zero ? null : (SOUND_NONBLOCK_CALLBACK)Marshal.GetDelegateForFunctionPointer<SOUND_NONBLOCK_CALLBACK>(nonblockcallback_internal); }
        }
        public FILE_OPEN_CALLBACK? Fileuseropen
        {
            ...
            get { return fileuseropen_internal == IntPtr.Zero ? null : (FILE_OPEN_CALLBACK)Marshal.GetDelegateForFunctionPointer<FILE_OPEN_CALLBACK>(fileuseropen_internal); }
        }
        public FILE_CLOSE_CALLBACK? Fileuserclose
        {
            ...
            get { return fileuserclose_internal == IntPtr.Zero ? null : (FILE_CLOSE_CALLBACK)Marshal.GetDelegateForFunctionPointer<FILE_CLOSE_CALLBACK>(fileuserclose_internal); }
        }
        public FILE_READ_CALLBACK? Fileuserread
        {
            ...
            get { return fileuserread_internal == IntPtr.Zero ? null : (FILE_READ_CALLBACK)Marshal.GetDelegateForFunctionPointer<FILE_READ_CALLBACK>(fileuserread_internal); }
        }
        public FILE_SEEK_CALLBACK? Fileuserseek
        {
            ...
            get { return fileuserseek_internal == IntPtr.Zero ? null : (FILE_SEEK_CALLBACK)Marshal.GetDelegateForFunctionPointer<FILE_SEEK_CALLBACK>(fileuserseek_internal); }
        }
        public FILE_ASYNCREAD_CALLBACK? Fileuserasyncread
        {
            ...
            get { return fileuserasyncread_internal == IntPtr.Zero ? null : (FILE_ASYNCREAD_CALLBACK)Marshal.GetDelegateForFunctionPointer<FILE_ASYNCREAD_CALLBACK>(fileuserasyncread_internal); }
        }
        public FILE_ASYNCCANCEL_CALLBACK? Fileuserasynccancel
        {
            ...
            get { return fileuserasynccancel_internal == IntPtr.Zero ? null : (FILE_ASYNCCANCEL_CALLBACK)Marshal.GetDelegateForFunctionPointer<FILE_ASYNCCANCEL_CALLBACK>(fileuserasynccancel_internal); }
        }
...
#pragma warning restore 414
    ...
    */
    public struct System
    {
        ...
        {
            settings.cbSize = MarshalHelper.SizeOf<ADVANCEDSETTINGS>();
        ...
        public RESULT CreateSound(string name, MODE mode, out Sound sound)
        {
            ...
            exinfo.cbsize = MarshalHelper.SizeOf<CREATESOUNDEXINFO>();
    ...
    */
    public struct DSP
    {
        ...
        public RESULT GetParameterInfo(int index, out DSP_PARAMETER_DESC? desc)
        {
            ...
            desc = (DSP_PARAMETER_DESC?)MarshalHelper.PtrToStructure<DSP_PARAMETER_DESC>(descPtr);
            return result;
        }
    ...
    */
    ...
    {
        public readonly IntPtr NativeUtf8Ptr;
    ...
    static class StringHelper
    {
        ...
        static readonly List<ThreadSafeEncoding> _encoders = new List<ThreadSafeEncoding>(1);
