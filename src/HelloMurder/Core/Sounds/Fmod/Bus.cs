...
namespace HelloMurder.Core.Sounds.Fmod
{
    ...
    public class BusComparer : IEqualityComparer<Bus>
    {
        public readonly static BusComparer Default = new();

        public bool Equals(Bus? x, Bus? y)
        {
            if (x == null || y == null)
            {
        ...
        public int GetHashCode([DisallowNull] Bus b)
        {
            return b.Guid.GetHashCode();
        }
    }
}
